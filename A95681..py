#The first is the reverse engineering and has time complexity of  O(n^2)
#The second code under the first is the optimized code and has run time complexity of  O(n)
